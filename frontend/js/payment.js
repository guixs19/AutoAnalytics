// payment.js - VERSÃO PROTEGIDA v2.3 (ESCOPO ISOLADO)
// ==============================================
// 🔥 CORREÇÕES V2.3:
// 1. IIFE para evitar conflitos de constantes (MAX_CREDITS_BALANCE, etc.)
// 2. Organização do código em seções claras
// 3. Melhorias de performance e legibilidade
// 4. Todas as funções expostas globalmente no final
// ==============================================

(function() {
    'use strict';

    console.log('🚀 Inicializando payment.js v2.3 (escopo isolado)...');
    ...
    console.log('✅ payment.js v2.3 carregado com sucesso em escopo isolado!');

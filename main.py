# main.py (na raiz) - VERSÃO PRODUÇÃO v4.1 (CORREÇÃO DE IMPORTAÇÕES)
"""
AutoAnalytics - Servidor Principal
================================================================================
🔥 CORREÇÕES v4.1:
- ✅ CORRIGIDO: Importação do pipeline de backend.ml.preprocessing
- ✅ CORRIGIDO: get_db_safe() para evitar erro na rota premium-status
- ✅ CORRIGIDO: Verificação segura do pipeline no main
- ✅ CORRIGIDO: Fallback para todas as importações críticas
================================================================================
"""
...
print("=" * 75)
print("🚀 AUTOANALYTICS v4.1 - PRODUÇÃO")
print("=" * 75)
...
# 🔥 11.6 ML Pipeline - CORRIGIDO (importa de backend.ml.preprocessing)
...
if __name__ == "__main__":
    ...
    # 🔥 CORRIGIDO: Verifica pipeline de forma segura
